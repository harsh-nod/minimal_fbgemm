...
// Specialization for AccumulateTypeDevice to handle Vec4T<float>
namespace at {
template<>
struct AccumulateTypeDevice<fbgemm_gpu::Vec4T<float>, c10::DeviceType::CUDA> {
  using type = fbgemm_gpu::Vec4T<float>;
};
}
